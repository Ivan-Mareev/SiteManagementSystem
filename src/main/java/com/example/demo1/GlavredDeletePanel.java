...
public class GlavredDeletePanel {
...
//        assert addBtn != null : "fx:id=\"addBtn\" was not injected: check your FXML file 'glavredDelete-panel.fxml'.";
//        assert txtField != null : "fx:id=\"txtField\" was not injected: check your FXML file 'glavredDelete-panel.fxml'.";
        addBtn.setOnAction(actionEvent -> {
            try (Connection connection = DriverManager.getConnection(Configs.DATABASE_URL, Configs.USER_NAME, Configs.DATABASE_PASS)) {
                ...
                if (!theme.isBlank()) {
                    if (DataBaseHandler.checkPublicationInDB(connection, theme)) {
                        DataBaseHandler.publicationDelete(connection, theme);
                        Stage newWindow = new Stage();
                        newWindow.setTitle("Успех!");

                        Label label = new Label("Тема удалена!");
                        ...
                        Label label = new Label("Тема не найдена!");
